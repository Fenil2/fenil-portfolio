  ...
  const socialLinks = [
    {
      ...
      url: 'https://github.com/sivasubramaniam-17',
      color: '#333'
    },
    {
      name: 'LinkedIn',
      ...
      url: 'https://www.linkedin.com/in/siva-subramaniam-s-881b4727b/',
      color: '#0077b5'
    },
    {
      name: 'WhatsApp',
    ...
    },
    {
      ...
      url: 'mailto:sivasubramaniam624@gmail.com',
      color: '#EA4335'
    }
  ];
  ...
  return (
    <section id="contact" className="contact-section">
      <div className="contact-container">
        {/* Left Section - Header & Social Links */}
        <motion.div
          ...
          <div className="contact-info">
            ...
            >
              ...
              <div className="info-text">
                ...
                <a href="tel:+919360810288" className="info-value">+91 93608 10288</a>
              </div>
            </motion.div>
          </div>
        </motion.div>
