...
const Footer = () => {
  ...
  const footerLinks = {
    ...
    social: [
      {
        name: 'GitHub',
        href: 'https://github.com/sivasubramaniam-17',
        icon: (
      ...
      {
        name: 'LinkedIn',
        href: 'https://www.linkedin.com/in/siva-subramaniam-s-881b4727b/',
        icon: (
          <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
      ...
      {
        name: 'Email',
        href: 'mailto:sivasubramaniam624@gmail.com',
        icon: (
      ...
      <div className="footer-container">
          ...
          >
            ...
            >
              ...
              <div className="logo-name">
                <span className="logo-primary">Siva.S</span>
            ...
            >
              ...
              <span>sivasubramaniam624@gmail.com</span>
              {emailCopied && (
                <motion.span
        ...
        >
          <div className="footer-copyright">
            <span>&copy; {currentYear} Siva. All rights reserved.</span>
          </div>
