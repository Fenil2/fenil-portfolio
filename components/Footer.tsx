...
const Footer = () => {
  ...
  const footerLinks = {
    ...
    social: [
      {
        name: 'GitHub',
        href: 'https://github.com/HarishFenil',
        icon: (
      ...
      {
        name: 'LinkedIn',
        href: 'https://www.linkedin.com/in/fenil-rr/',
        icon: (
          <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
      ...
      {
        name: 'Email',
        href: 'mailto:fenilf86@gmail.com',
        icon: (
  ...
  const copyEmail = () => {
    navigator.clipboard.writeText('fenilf86@gmail.com');
    setEmailCopied(true);
      ...
      <div className="footer-container">
          ...
          >
            ...
            >
              ...
              <div className="logo-name">
                <span className="logo-primary">Fenil.RR</span>
                <span className="logo-secondary">Web Developer</span>
              </div>
            </motion.div>
        ...
        >
          <div className="footer-copyright">
            <span>&copy; {currentYear} Fenil RR. All rights reserved.</span>
          </div>
